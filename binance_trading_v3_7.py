...
def suggest_limit_buy(
    ...
    note_parts = [
        ...
        "La selección de entradas 3.6 prioriza zonas operativas, fuerza escalones distintos (aggressive/base/conservative), exige separación mínima entre escalones y devuelve null cuando no existen niveles realmente distintos."
    ]
...
# =========================
# Enriquecimiento de watchlist v3.6
# =========================
...
def classify_pullback_quality(last_price: Optional[float], recent_high_1h: Optional[float], c1: Optional[float], ma25_1: Optional[float], ma99_1: Optional[float], c15: Optional[float], ma25_15: Optional[float], ma7_15: Optional[float]) -> str:
...
def score_rebound_candidate(symbol: str, public_data: Dict[str, Any], capital_quote: float = 35.0) -> Dict[str, Any]:
    ...
    pullback_quality = classify_pullback_quality(last_price, recent_high_1, c1, ma25_1, ma99_1, c15, ma25_15, ma7_15)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Binance Trading v3.6: modo posición (OCO) y modo mercado (watchlist avanzado)."
    )
