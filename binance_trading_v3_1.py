...
def score_rebound_candidate(symbol: str, public_data: Dict[str, Any], capital_quote: float = 35.0) -> Dict[str, Any]:
    ...
    # Spread: pesa más que el volumen bruto
    ...
    # Liquidez relativa al capital, no umbral bruto
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Binance Trading v3.1: modo posición (OCO) y modo mercado (watchlist)."
    )
