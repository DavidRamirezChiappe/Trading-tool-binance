...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Binance Trading v4.1.3: modo posición (OCO) y modo mercado (watchlist ejecutable + vigilancia ampliada)."
    )
