...
# Binance Trading Tools v3.4.1.1
...
def suggest_limit_buy(
    ...
    note_parts = [
        ...
        "La selección de entradas 3.4.1 fuerza escalones distintos (aggressive/base/conservative), exige una separación mínima entre escalones y devuelve null cuando no existen niveles realmente distintos."
    ]
